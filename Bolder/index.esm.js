...
// index.js
var Bolder_default = Mark2.create({
  name: "Bolder",
  renderHTML({ HTMLAttributes }) {
    return ["strong", mergeAttributes(HTMLAttributes)];
  },
  addInputRules() {
    const regex = /(\/\*\*([^*]+)\*\/)$/;
    return [
      markInputRule({
        find: regex,
        type: this.type,
        // The getText function extracts the content (Group 2) to apply the mark to.
        // Tiptap automatically replaces the full match (Group 1) with the content from getText().
